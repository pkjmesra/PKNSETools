...
class morningstarDataFetcher(fetcher):
    def fetchMorningstarTopDividendsYieldStocks(self):
        ...
        try:
            ...
            rows = data["rows"]
            # Optimized: Create DataFrame directly from list instead of concat in loop
            output = pd.DataFrame(rows, columns=["name", "marketCap","exchangeId", "dividendYield", "closePrice","peRatio"])
